...
//Realiza que o nome da classe seja calcular e que na própria declaração das váriaveis a uma soma de 2+1,divisão 70/2,multiplicação 90*2,subtração 3-1,cálculo do resultado da soma+ a de divisão,
...
class Calcular{//Nome da Classe
 public static void Main(){//Sem o Main deixando só a classe com seu nome não vai compilar.
    ...
    Console.WriteLine("Os cálculos realizados foram a soma,divisão,multiplicação e subtração\n");
